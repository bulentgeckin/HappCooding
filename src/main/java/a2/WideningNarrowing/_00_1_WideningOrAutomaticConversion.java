...
public class _00_1_WideningOrAutomaticConversion {
	...
	public static void main(String[] args) {
		...
		/**
		 * Widening or Automatic Conversions Byte --> short --> int --> long --> float
		 * --> double
		 */

		byte byte_a = 10; // byte range -128 to 127
		short short_a = byte_a;
		int int_a = short_a;
		long long_a = int_a;
		...
		// byte result=byte_a+short_a+int_a+long_a+float_a+double_a; NOT POSSIBLE 
